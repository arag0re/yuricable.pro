...
const Credits = () => {
   ...
   const embedYouTubeVideo = (videoId: string) => (
      <div>
         <iframe
      ...
      <div className="web-serial-container" style={containerStyle}>
         ...
         <div style={videoLinksContainerStyle} id="videoLinks">
            <p>
               ...
               for an example RaspberryPi-Pico implementation and his talks on
               the subject.
            </p>
            ...
            <ul>
               <li>
                  <span
                     style={linkStyle}
                     onClick={() => toggleVideo('8p3Oi4DL0eI')}
                  >
                     The Hitchhacker’s Guide to iPhone Lightning and JTAG
                     Hacking
                  </span>
                  {selectedVideo === '8p3Oi4DL0eI' &&
                     embedYouTubeVideo('8p3Oi4DL0eI')}
               </li>
               <li>
                  <span
                     style={linkStyle}
                     onClick={() => toggleVideo('vmQcrU5pNvU')}
                  >
                     Inside Apple's Lightning: JTAGging The iPhone For Fuzzing
                     And Profit
                  </span>
                  {selectedVideo === 'vmQcrU5pNvU' &&
                     embedYouTubeVideo('vmQcrU5pNvU')}
               </li>
               <li>
                  <span
                     style={linkStyle}
                     onClick={() => toggleVideo('-nFWcKHIUN4')}
                  >
                     Stacksmashing- Inside Apple’s Lightning: JTAGging the
                     iPhone for Fuzzing and Profit
                  </span>
                  {selectedVideo === '-nFWcKHIUN4' &&
                     embedYouTubeVideo('-nFWcKHIUN4')}
               </li>
               <li>
                  <span
                     style={linkStyle}
                     onClick={() => toggleVideo('p5tMaWsuGk0')}
                  >
                     The secrets of Apple Lightning - Part 1
                  </span>
                  {selectedVideo === 'p5tMaWsuGk0' &&
                     embedYouTubeVideo('p5tMaWsuGk0')}
               </li>
               <li>
                  <span
                     style={linkStyle}
                     onClick={() => toggleVideo('D8UGlvBubkA')}
                  >
                     Getting JTAG on the iPhone 15
                  </span>
                  {selectedVideo === 'D8UGlvBubkA' &&
                     embedYouTubeVideo('D8UGlvBubkA')}
               </li>
            </ul>
         </div>
